        ...
        <div className="flex items-center gap-3">
          ...
          {canAdvance ? (
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-lg bg-accent px-3 py-1.5 font-mono text-[10px] uppercase tracking-[0.14em] text-background transition hover:opacity-90"
            >
              Next step
